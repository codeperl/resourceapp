...
(function () {
  ...
  if (document.getElementById("type-writing")) {
    var typed = new (typed_js__WEBPACK_IMPORTED_MODULE_0___default())('#type-writing', {
      strings: ['and it\'s obvious', 'and we do it precisely', 'and we use business\' legacy metadata to build glorious future', 'and we build tailored data driven web applications', 'and we build tailored data driven websites', 'and we measure business solutions', 'and we maintain business solutions', 'and we care our clients', 'and we are interested for long-term mates', 'we are data driven website'],
      typeSpeed: 100,
      startDelay: 1000,
      backSpeed: 50,
      shuffle: true,
