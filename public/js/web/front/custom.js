...
$(document).on('click', '.gdpr-tgl-btn', function (e) {
  ...
  if ($(this).parent().parent().parent().hasClass('gdpr-minimal')) {
    ...
    $(this).parent().parent().parent().removeClass('d-flex').removeClass('justify-content-between').addClass('d-none'); // gdpr-detail section show!
    ...
    $(this).parent().parent().parent().removeClass('d-block').addClass('d-none'); // gdpr-minimal section show!
